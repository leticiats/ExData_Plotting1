...
#--------------------------------------------------------------------------------
# Creating Plot 3: Timeseries of of Different Submeters with Legend
#--------------------------------------------------------------------------------

print("Creating Timeseries of of Different Submeters with Legend...")
...
plot(powerDate$DT,powerDate$Sub_metering_1, type="l",
...
wd <- getwd()
message(paste("Plot save successfully as 'plot3' at",wd, sep = " "))
