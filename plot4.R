...
#--------------------------------------------------------------------------------
# Creating Plot 4: Dashboard with Different Plots
#--------------------------------------------------------------------------------

print("Creating Dashboard with Different Plots...")
...
plot(powerDate$DT,powerDate$Sub_metering_1, type="l",ylab="Energy 
     sub metering",xlab="", col="black")

points(powerDate$DT,powerDate$Sub_metering_2, xlab="", 
       col="red", type="l")

points(powerDate$DT,powerDate$Sub_metering_3, xlab="", 
       col="blue", type="l")

legend("topright", col=c("black","red","blue"), 
       legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3" ), 
       lty="solid", border="white")

plot(powerDate$DT,powerDate$Global_reactive_power, type="l",
...
wd <- getwd()
message(paste("Plot save successfully as 'plot4' at",wd, sep = " "))